...
/**
 * API handler for retrieving categories with counts
...
export default async function handler(req, res) {
  ...
  try {
    // Establish database connection with endpoint name for mock data
    connection = await connectDB('dataCategories');
    ...
    console.error('Data Categories API error:', error);

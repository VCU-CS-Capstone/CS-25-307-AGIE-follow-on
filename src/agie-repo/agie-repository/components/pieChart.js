...
const categoryExplanations = {
  ...
  'Evaluation & Workload': 'Fair assessment and distribution of responsibilities',
    ...
    <div className="flex flex-col w-full">
      {isLoading ? (
        ...
        <>
          ...
          <div className="mt-4">
            <h3 className="text-lg font-semibold mb-3" style={{ color: '#CDAE5E' }}>Category Breakdown</h3>
                    ...
                    <tr key={index} className="border-t border-gray-200 hover:bg-gray-100">
                      <td className="p-2">
                        <div className="flex items-center">
                          ...
                          ></span>
                          <span title={categoryExplanations[category.categoryName]}>
                            {category.categoryName}
                          </span>
                        </div>
                      </td>
                      <td className="p-2 text-right font-medium">{category.categoryCount}</td>
                    </tr>
                  ))}
                </tbody>
              </table>

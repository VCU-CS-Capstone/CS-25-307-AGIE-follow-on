...
1.	Catalog other Gender Inclusion and Equity (GIE) repositories and sites,
2.	Review partners and publications of NSF ADVANCE,
3.	Review NIH repository landing pages and other repository documents.
4.	Design the AGIE repository, incorporating lessons from tasks 1-3.
5.	Build a second iteration of the AGIE repository (last year was the first).
